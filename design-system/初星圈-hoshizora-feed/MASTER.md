...
**Project:** 初星圈 Hoshizora Feed
**Generated:** 2026-06-28 23:30:13
**Category:** Social Media App
**Host:** `hatsu-produce-local` mini-phone · `world/buzz-pool.js`

---

## 初星学园 · 生态位（本地化）

本设计系统服务 **公开层 SNS**，与现有手机 App 分工：

| App | 设计气质 | 状态栏 class |
|-----|----------|--------------|
| LINE | 白底 + `#06c755` | `is-line` |
| 广播部 | 深紫暖字 | `is-broadcast` |
| **初星圈** | 暖白 + 玫瑰/星金 | `is-sns` |
